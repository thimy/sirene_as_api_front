<template>
  <section class="section section-grey">
    ...
    <div class="container container__subtext">
      ...
      <p>
        Si vos besoins excèdent les limites de nos serveurs, par exemple si vous voulez effectuer davantage de requêtes, vous pouvez installer votre propre copie de l'API.
